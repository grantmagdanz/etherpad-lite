...
ARG ETHERPAD_PLUGINS="ep_align ep_comments_page ep_embedded_hyperlinks2 ep_font_color ep_headings2 ep_markdown"
...
HEALTHCHECK --interval=20s --timeout=3s CMD curl -f http://localhost:10000 || exit 1
